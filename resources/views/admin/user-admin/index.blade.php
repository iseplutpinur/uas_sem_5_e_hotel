...
@section('admin-content')
    <div class="container-fluid">
        <h1 class="h3 mb-4 text-gray-800">User Admin</h1>
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-5" align="right">
                        <a href="{{ route('admin.user-admin.add') }}" class="btn btn-success"><i class="fas fa-plus"></i></a>
    ...
    @push('scripts')
        <script type="text/javascript">
            ...
            function loadTable(page) {
                var url = "{{ route('admin.user-admin') }}";
                if (page != "") {
                    url += "?page=" + page;
                }
                $.ajax({
